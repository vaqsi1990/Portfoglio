...
export default function Hero() {
  return (
    <section className="mx-auto flex min-h-[70vh] max-w-6xl flex-col items-center gap-10 px-6 py-16 md:flex-row md:justify-between">
      ...
      <div className="mx-auto flex flex-row items-center gap-8 md:relative md:-top-24 md:self-start">
        <div className="relative h-[500px] w-[320px] overflow-hidden rounded-2xl sm:h-[620px] sm:w-[400px] md:h-[820px] md:w-[560px]">
          <Image
            src="/me.png"
